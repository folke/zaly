...
const toBaseColor = (() => { const _iv1 = new Set(["red", "black", "green", "yellow", "blue", "magenta", "cyan", "white", "gray", "grey", "brightRed", "brightBlack", "brightGreen", "brightYellow", "brightBlue", "brightMagenta", "brightCyan", "brightWhite", "brightGray", "brightGrey", "shiki", "fg", "bg", "primary", "accent", "dim", "muted", "success", "info", "warn", "error", "title", "border", "borderTitle", "line", "mdBold", "mdItalic", "mdStrikethrough", "mdHeading", "mdHeading1", "mdHeading2", "mdHeading3", "mdHeading4", "mdHeading5", "mdHeading6", "mdCode", "mdCodeBlock", "mdCodeBlockTitle", "mdHr", "mdLink", "mdListBullet", "mdListChecked", "mdListUnchecked", "mdQuote", "mdTable", "mdTableHeader", "menuLabel", "menuHint", "menuActive", "code", "codeTitle", "diffAdd", "diffContext", "diffDel", "diffLine", "diffTitle", "inherit"]); const _av2 = new Set(["red", "black", "green", "yellow", "blue", "magenta", "cyan", "white", "gray", "grey", "brightRed", "brightBlack", "brightGreen", "brightYellow", "brightBlue", "brightMagenta", "brightCyan", "brightWhite", "brightGray", "brightGrey", "shiki", "fg", "bg", "primary", "accent", "dim", "muted", "success", "info", "warn", "error", "title", "border", "borderTitle", "line", "mdBold", "mdItalic", "mdStrikethrough", "mdHeading", "mdHeading1", "mdHeading2", "mdHeading3", "mdHeading4", "mdHeading5", "mdHeading6", "mdCode", "mdCodeBlock", "mdCodeBlockTitle", "mdHr", "mdLink", "mdListBullet", "mdListChecked", "mdListUnchecked", "mdQuote", "mdTable", "mdTableHeader", "menuLabel", "menuHint", "menuActive", "code", "codeTitle", "diffAdd", "diffContext", "diffDel", "diffLine", "diffTitle", "inherit"]); const __is = (input: any): input is HexColor | AnsiColorName | BrightAnsiColorName | ThemeKey | "inherit" => null !== input && undefined !== input && (true === _iv1.has(input) || "string" === typeof input && RegExp(/^#(.*)/).test(input)); let _errorFactory: any; return (input: any, errorFactory?: (p: import("typia").TypeGuardError.IProps) => Error): HexColor | AnsiColorName | BrightAnsiColorName | ThemeKey | "inherit" => {
    if (false === __is(input)) {
