    ...
    components: {
        schemas: {
            ...
            Color: {
                ...
                pattern: "^((#(.*))|(#(.*)\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(#(.*)\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(accent\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(accent\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(border\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(border\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(borderTitle\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(borderTitle\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(code\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(code\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(codeTitle\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(codeTitle\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(comment\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(comment\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(delim\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(delim\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(diffAdd\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(diffAdd\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(diffContext\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(diffContext\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(diffDel\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(diffDel\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(diffLine\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(diffLine\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(diffTitle\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(diffTitle\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(divider\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(divider\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(error\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(error\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(gutter\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(gutter\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(highlight\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(highlight\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(id\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(id\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(info\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(info\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdBold\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdBold\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdCode\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdCode\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdCodeBlock\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdCodeBlock\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdCodeBlockTitle\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdCodeBlockTitle\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading1\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading1\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading2\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading2\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading3\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading3\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading4\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading4\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading5\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading5\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading6\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHeading6\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHr\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdHr\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdItalic\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdItalic\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdLink\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdLink\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdListBullet\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdListBullet\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdListChecked\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdListChecked\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdListUnchecked\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdListUnchecked\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdQuote\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdQuote\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdStrikethrough\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdStrikethrough\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdTable\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdTable\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdTableHeader\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(mdTableHeader\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(muted\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(muted\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(name\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(name\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(optionActive\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(optionActive\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(optionDesc\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(optionDesc\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(optionName\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(optionName\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(overlay\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(overlay\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(primary\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(primary\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(prompt\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(prompt\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(quiet\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(quiet\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(selection\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(selection\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(shiki\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(shiki\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(subtle\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(subtle\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(success\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(success\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxBoolean\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxBoolean\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxBracket\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxBracket\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxConstant\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxConstant\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxDelimiter\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxDelimiter\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxField\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxField\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxFunction\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxFunction\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxNumber\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxNumber\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxSpecial\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxSpecial\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxString\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(syntaxString\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(text\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(text\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(title\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(title\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(ui\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(ui\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(warn\\+[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)|(warn\\x2d[+-]?\\d+(?:\\.\\d+)?(?:[eE][+-]?\\d+)?))$",
