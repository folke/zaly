...
const validator = (() => {
    const _ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => (undefined === input.lastModel || "string" === typeof input.lastModel || _assertGuard_1._assertGuard(_exceptionable, {
        method: "typia.createAssertEquals",
        path: _path + ".lastModel",
        expected: "(string | undefined)",
        value: input.lastModel
    }, _errorFactory)) && (undefined === input.inputHistory || (Array.isArray(input.inputHistory) || _assertGuard_1._assertGuard(_exceptionable, {
        method: "typia.createAssertEquals",
        path: _path + ".inputHistory",
        expected: "(Array<string> | undefined)",
        value: input.inputHistory
    }, _errorFactory)) && input.inputHistory.every((elem: any, _index2: number) => "string" === typeof elem || _assertGuard_1._assertGuard(_exceptionable, {
        method: "typia.createAssertEquals",
    ...
    const __is = (input: any, _exceptionable: boolean = true): input is State => "object" === typeof input && null !== input && false === Array.isArray(input) && _io0(input, true);
    let _errorFactory: any;
    return (input: any, errorFactory?: (p: import("typia").TypeGuardError.IProps) => Error): State => {
        if (false === __is(input)) {
